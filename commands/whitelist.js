...
exports.execute = async (client, message, args) => {
  let embed = new MessageEmbed().setColor("#f2b5c8").setAuthor(message.member.displayName, message.author.avatarURL({ dynamic: true, })).setFooter(`Embed Koruma Sistemi`).setTimestamp();
...
.setFooter(`Embed Koruma Sistemi`)
.setTimestamp()
  let beklenen;
